...
for line in sys.stdin: 
	...
	if 'H' in cigar or 'P' in cigar or 'N' in cigar:
		print(sys.stderr.write(),'cigar found:',cigar,'PMDtools only supports cigar operations M, I, S and D, the alignment has been excluded')
		continue
...
if options.stats:
	...
	print(sys.stderr.write(),'" excluded due to clipping:',clipexcluded)
	print(sys.stderr.write(),'" excluded due to indels:',indelexcluded)
	print(sys.stderr.write(),'" no MD field:',noMD)
	print(sys.stderr.write(),'" no G or C in ref:',noGCexcluded)
	print(sys.stderr.write(),'" total seqs:',passed)
	print(sys.stderr.write(),'" excluded due to PMD score <',str(int(options.threshold))+':',excluded_threshold)
	print(sys.stderr.write(),'" passed seqs:',(passed-excluded_threshold))
	print(sys.stderr.write(),'""""""""""""""""""""""""""""""""')
